...
def train(batch_size, prefix):
    ...
    train_data = data.Mov3dStack('data/Imdb', (384,160), batch_size, scale, output_depth=False,
            data_frames=data_frames, flow_frames=flow_frames, stride=stride, no_left0=no_left0, right_whiten=right_whiten)
    test_data = data.Mov3dStack('data/Imdb', (384,160), batch_size, scale, output_depth=False,
            data_frames=data_frames, flow_frames=flow_frames,test_mode=True, stride=stride, no_left0=no_left0, right_whiten=right_whiten)
